...
#         builder.adjust(3)
#
#         sent = await bot.send_message(chat_id=game_round.chat_id, text=text.first.format(user1=player1.username,
...
#     if game_round.waiting_time2 <= 0 and game_round.user1_choice not in [1, 2, 3]:
...
#         return
#     if game_round.waiting_time2 <= 0 and game_round.user2_choice not in [1, 2, 3]:
...
#         await sync_to_async(game_round.save)()
#         await round_waiter(game_round, game, bot)
#         return
